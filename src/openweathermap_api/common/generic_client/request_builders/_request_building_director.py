from src.openweathermap_api.common.generic_client._request_exceptions import WrongRequestType
from src.openweathermap_api.common.generic_client.request_builders._concrete_request_builders import GetAndDeleteRequestBuilder, PostAndPutRequestBuilder
...
class RequestDirector:
    ...
    def _common_request_build(self, builder, req_type, url, data, headers):
        ...
        return builder.get_and_finish_build()
