import requests
from src.openweathermap_api.common.generic_client._request_exceptions import UnknownOptionalParameter
from src.openweathermap_api.common.generic_client.request_builders import RequestDirector
