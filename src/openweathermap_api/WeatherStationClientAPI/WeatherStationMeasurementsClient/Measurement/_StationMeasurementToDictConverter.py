from src.openweathermap_api.WeatherStationClientAPI.WeatherStationMeasurementsClient.Measurement._StastionMeasurment import StationMeasurementCloudsDetails, \
