...
from src.openweathermap_api.WeatherStationClientAPI.WeatherStationMeasurementsClient.Measurement import StationMeasurement, StationMeasurementToDictConverter
