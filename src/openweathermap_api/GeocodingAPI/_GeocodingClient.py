...
from src.openweathermap_api.GeocodingAPI._GeocodingUtils import ALLOWED_OPTIONAL_PARS, GeocodingUrls


class GeocodingClient(Client):
    ...
    dict[str, Any]:
        ...
        response = parse_request_response_to_format(request_response)
        return response
