from src.openweather_api.Common.GenericClient.Exceptions import UnknownOptionalParameter
from src.openweather_api.WeatherClient.Constants import Format
import json
