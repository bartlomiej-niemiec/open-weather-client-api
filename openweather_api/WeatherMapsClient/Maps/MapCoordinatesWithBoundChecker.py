from openweather_api.WeatherMapsClient.Maps.MapCoordinates import MapCoordinates
from openweather_api.WeatherMapsClient.Maps.Exceptions import raise_out_of_range_exception
