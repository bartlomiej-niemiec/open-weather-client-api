...
from openweather_api.WeatherTriggersClient.Triggers import TriggerTimePeriod
from openweather_api.WeatherTriggersClient.Triggers.Exceptions import NotImplemented
