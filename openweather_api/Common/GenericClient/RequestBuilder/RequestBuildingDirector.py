from openweather_api.Common.GenericClient.Exceptions import WrongRequestType
from openweather_api.Common.GenericClient.RequestBuilder.ConcreteBuilders import GetAndDeleteRequestBuilder, PostAndPutRequestBuilder
